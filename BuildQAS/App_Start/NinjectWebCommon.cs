...
namespace BuildInspect.App_Start
{
    ...
    public class NinjectWebCommon
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<IAssessmentServices>().To<AssessmentServices>();

            kernel.Bind<IQCInspectionRepository>().To<QCInspectionRepository>();
            kernel.Bind<IQCInspectionServices>().To<QCInspectionServices>();
        }
    }
}