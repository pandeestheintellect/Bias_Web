...
namespace BuildInspect.Models.Domain
{
    ...
    public partial class assessment_external_works_trn_detail
    {
        public int AssessmentEWKDetailID { get; set; }
        public Nullable<int> AssessmentEWKID { get; set; }
        ...
        public virtual assessment_external_works_trn assessment_external_works_trn { get; set; }
